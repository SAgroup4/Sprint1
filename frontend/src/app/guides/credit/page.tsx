  ...
  return (
    <div className={styles.transferPage}>
      <div className={styles.transferContainer}>
        ...
        <div className={styles.ruleList}>
          <h3 className={styles.ruleTitle}>✅ 什麼可以抵免？</h3>
          <ul>
            <li>入學前已修習且及格的科目與學分，可申請抵免！</li>
            <li>需經「系(所)初審」＋「院主管核定」＋「教務處複審」通過。</li>
          </ul>

          <h3 className={styles.ruleTitle}>⏳ 抵免時間注意！</h3>
          <ul>
            <li>只能在「入學當學期」申請！</li>
          ...
          <h3 className={styles.ruleTitle}>🚫 不能抵免的情況</h3>
          <ul>
            <li>雙重學籍 ➔ 學分分開計算，不能互抵！</li>
            <li>大學入門、人生哲學、專業倫理等 ➔ 原則上不能抵免，但曾修過且及格者可以。</li>
          </ul>

          <h3 className={styles.ruleTitle}>🔍 審查標準怎麼看？</h3>
          <ul>
            <li>科目名稱、內容相同 ➔ 可抵免</li>
            <li>名稱不同但內容相同 ➔ 可抵免</li>
            <li>性質相近 ➔ 可抵免</li>
          ...
          <h3 className={styles.ruleTitle}>🛡️ 特殊情況 - 軍訓抵免</h3>
          <ul>
        ...
        <div className={styles.ruleList}>
          <h3 className={styles.ruleTitle}>📢 注意事項</h3>
          <ul>
        ...
        <div style={{ backgroundColor: '#e2e8f0', padding: '24px', borderRadius: '12px', marginTop: '32px' }}>
          ...
          <div className={styles.flowContainer}>
            ...
            <div className={styles.flowSplit}>
              <div className={styles.flowSplitItem}>
                <p>各系(所)或師資培育中心初審</p>
              </div>
              <div className={styles.flowSplitItem}>
                <p>註冊組複審</p>
